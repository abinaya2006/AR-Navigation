        ...
        for(let i=0;i<steps.length;i++){
            ...
            if(i>0){
                $("#scene_container").append(
                    <a-entity gps-entity-place="latitude:${steps[i].manuever.location[1]};
                    longitude:${steps[i].manuever.location[0]}">
                        <a-image name="${instruction}" src="./assets/${images[image]}"
                        look-at="#step_${i-1}" scale="5 5 5" id="step_${i}"
                        position="0 0 0" 
                        ></a-image>
                ...
                $("#scene_container").append(
                    <a-entity gps-entity-place="latitude:${steps[i].manuever.location[1]};
                    longitude:${steps[i].manuever.location[0]}">
                        <a-image name="${instruction}" src="./assets/ar_start.png"
                        look-at="#step_${i-1}" scale="5 5 5" id="step_${i}"
                        position="0 0 0" 
                        ></a-image>
